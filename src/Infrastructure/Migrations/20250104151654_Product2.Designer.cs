...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250104151654_Product2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Product", b =>
                {
                    ...
                    b.HasIndex("FromId")
                        .HasDatabaseName("IX_Product_FromId");

                    b.HasIndex("FromToId");

                    b.HasIndex("ToId")
                        .HasDatabaseName("IX_Product_ToId");
            ...
            modelBuilder.Entity("Domain.Models.Product", b =>
                {
                    b.HasOne("Domain.Models.FromTo", null)
                        .WithMany()
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.FromTo", "FromTo")
                        .WithMany()
